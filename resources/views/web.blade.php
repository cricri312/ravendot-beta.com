...
@section('title', 'Web Development - ' . __('common.web_offercard_1_title'))
@section('meta_description', __('common.web_intro_1_text'))
                ...
                <div class="hero-content-row">
                    <div class="hero-content">
                        <div class="hero-badge">
                            <span>{{ __('common.badge_web') }}</span>
                        </div>

                        <h1 class="hero-title">
                            {{ __('common.web_offercard_1_title') }}
                        </h1>

                        <div class="hero-divider"></div>

                        <div class="hero-text">
                            <p>{{ __('common.web_intro_1_text') }}</p>
                            <p style="margin-top: 20px;">{{ __('common.web_intro_2_text') }}</p>
                        </div>
                    ...
                    <div class="hero-image">
                        <img src="{{ asset('images/portfolio/web/UXUI_1.webp') }}" alt="Web Development">
                    </div>
                </div>
            </div>
                ...
                <div class="process-content">
                    <div class="process-steps">
                        ...
                        <div class="process-step-wrapper">
                            <div class="process-step">
                                <div class="step-badge">
                                    <span>{{ __('common.web_infocard_1_title') }}</span>
                                </div>
                                <h3 class="step-title">
                                    {{ __('common.web_infocard_1_text') }}
                                </h3>
                            </div>
                        ...
                        <div class="process-step-wrapper">
                            <div class="process-step">
                                <div class="step-badge">
                                    <span>{{ __('common.web_infocard_2_title') }}</span>
                                </div>
                                <h3 class="step-title">
                                    {{ __('common.web_infocard_2_text') }}
                                </h3>
                            </div>
                            <div class="step-image-mobile">
                        ...
                        <div class="process-step-wrapper">
                            <div class="process-step">
                                <div class="step-badge">
                                    <span>{{ __('common.web_infocard_3_title') }}</span>
                                </div>
                                <h3 class="step-title">
                                    {{ __('common.web_infocard_3_text') }}
                                </h3>
                            </div>
                            <div class="step-image-mobile">
                ...
                <div class="process-content">
                    <div class="process-steps">
                        ...
                        <div class="process-step-wrapper">
                            <div class="process-step">
                                <div class="step-badge">
                                    <span>{{ __('common.web_offercard_1_title') }}</span>
                                </div>
                                <h3 class="step-title">
                                    {{ __('common.web_offercard_1_text') }}
                                </h3>
                            </div>
                        </div>
                        ...
                        <div class="process-step-wrapper">
                            <div class="process-step">
                                <div class="step-badge">
                                    <span>{{ __('common.web_offercard_2_title') }}</span>
                                </div>
                                <h3 class="step-title">
                                    {{ __('common.web_offercard_2_text') }}
                                </h3>
                            </div>
                        </div>
                        ...
                        <div class="process-step-wrapper">
                            <div class="process-step">
                                <div class="step-badge">
                                    <span>{{ __('common.web_offercard_3_title') }}</span>
                                </div>
                                <h3 class="step-title">
                                    {{ __('common.web_offercard_3_text') }}
                                </h3>
                            </div>
                        </div>
                    </div>
        ...
        <div class="projects-wrapper">
            <div class="projects-container">
                <div class="projects-header">
                    <h2 class="projects-title">{{ __('common.portfolio_web_title') }}</h2>
                    <p class="projects-subtitle">
                        {{ __('common.portfolio_web_subtitle') }}
                    </p>
                </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 24px; margin-top: 60px;">
                    {{-- Code Projects --}}
                    @php
                        $codeProjects = ['psychology', 'chlebgosi', 'deltoradynamics', 'in3dnet', 'cryptonote', 'seorol', 'naitsirc'];
                    @endphp
                    ...
                    @for ($i = 1; $i <= 8; $i++)
                        <div style="border-radius: 16px; overflow: hidden; aspect-ratio: 4/3;">
                            <img src="{{ asset('images/portfolio/web/UXUI_' . $i . '.webp') }}"
                                 alt="UX/UI Design {{ $i }}"
                                 style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.3s ease;"
                                 onmouseover="this.style.transform='scale(1.05)'"
                                 onmouseout="this.style.transform='scale(1)'">
                    ...
                    @for ($i = 1; $i <= 4; $i++)
                        <div style="border-radius: 16px; overflow: hidden; aspect-ratio: 4/3;">
                            <img src="{{ asset('images/portfolio/web/WWW_' . $i . '.webp') }}"
                                 alt="Website {{ $i }}"
                                 style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.3s ease;"
                                 onmouseover="this.style.transform='scale(1.05)'"
                                 onmouseout="this.style.transform='scale(1)'">
                ...
                <div id="notify" class="footer-cta">
                    <div class="footer-cta-content">
                        <h2 class="footer-title">
                            {{ __('common.web_notify') }}
                        </h2>

                        <p class="footer-description">
                            {{ __('common.web_notify_text') }}
                        </p>

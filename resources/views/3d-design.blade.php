...
@section('title', '3D Design & Visualization - Ravendot')
@section('meta_description', __('common.3d_intro_text_1'))
                ...
                <div class="hero-content-row">
                    <div class="hero-content">
                        <div class="hero-badge">
                            <span>{{ __('common.badge_3d') }}</span>
                        </div>

                        <h1 class="hero-title">
                            {{ __('common.3d_infocard_1_title') }}
                        </h1>

                        <div class="hero-divider"></div>

                        <div class="hero-text">
                            <p>{{ __('common.3d_intro_text_1') }}</p>
                            <p style="margin-top: 20px;">{{ __('common.3d_intro_text_2') }}</p>
                        </div>
                    ...
                    <div class="hero-image">
                        <img src="{{ asset('images/portfolio/3d/3D_VIZ_1.webp') }}" alt="3D Visualization">
                    </div>
                </div>
            </div>
        ...
        <div class="about-wrapper">
            <div class="about-container">
                <div class="process-header">
                    <h2 class="process-title">{{ __('common.3d_why_ravendot') }}</h2>
                    <p class="process-subtitle">
                        {{ __('common.3d_benefits_text') }}
                    </p>
                </div>
                ...
                <div class="process-content">
                    <div class="process-steps">
                        ...
                        <div class="process-step-wrapper">
                            <div class="process-step">
                                <div class="step-badge">
                                    <span>{{ __('common.3d_offercard_1_title') }}</span>
                                </div>
                                <h3 class="step-title">
                                    {{ __('common.3d_offercard_1_text') }}
                                </h3>
                            </div>
                            <div class="step-image-mobile">
                                <img src="{{ asset('images/homepage/infocard/chart.webp') }}" alt="Innovation">
                            </div>
                        </div>
                        ...
                        <div class="process-step-wrapper">
                            <div class="process-step">
                                <div class="step-badge">
                                    <span>{{ __('common.3d_offercard_2_title') }}</span>
                                </div>
                                <h3 class="step-title">
                                    {{ __('common.3d_offercard_2_text') }}
                                </h3>
                            </div>
                            <div class="step-image-mobile">
                                <img src="{{ asset('images/homepage/infocard/crypto.webp') }}" alt="Creativity">
                            </div>
                        </div>
                        ...
                        <div class="process-step-wrapper">
                            <div class="process-step">
                                <div class="step-badge">
                                    <span>{{ __('common.3d_offercard_3_title') }}</span>
                                </div>
                                <h3 class="step-title">
                                    {{ __('common.3d_offercard_3_text') }}
                                </h3>
                            </div>
                            <div class="step-image-mobile">
                                <img src="{{ asset('images/homepage/infocard/nucle.webp') }}" alt="Flexibility">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="process-content">
                    <div class="process-steps">
                        ...
                        <div class="process-step-wrapper">
                            <div class="process-step">
                                <div class="step-badge">
                                    <span>{{ __('common.3d_infocard_1_title') }}</span>
                                </div>
                                <h3 class="step-title">
                                    {{ __('common.3d_infocard_1_text') }}
                                </h3>
                            </div>
                        </div>
                        ...
                        <div class="process-step-wrapper">
                            <div class="process-step">
                                <div class="step-badge">
                                    <span>{{ __('common.3d_infocard_2_title') }}</span>
                                </div>
                                <h3 class="step-title">
                                    {{ __('common.3d_infocard_2_text') }}
                                </h3>
                            </div>
                        </div>
                        ...
                        <div class="process-step-wrapper">
                            <div class="process-step">
                                <div class="step-badge">
                                    <span>{{ __('common.3d_infocard_3_title') }}</span>
                                </div>
                                <h3 class="step-title">
                                    {{ __('common.3d_infocard_3_text') }}
                                </h3>
                            </div>
                        </div>
                    </div>
        ...
        <div class="projects-wrapper">
            <div class="projects-container">
                <div class="projects-header">
                    <h2 class="projects-title">{{ __('common.portfolio_3d_title') }}</h2>
                    <p class="projects-subtitle">
                        {{ __('common.portfolio_3d_subtitle') }}
                    </p>
                </div>

                {{-- 3D Products Gallery --}}
                <div class="projects-header" style="margin-top: 60px;">
                    <h3 style="font-size: 32px; margin: 0;">{{ __('common.portfolio_3d_products') }}</h3>
                </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 24px; margin-top: 40px;">
                    @for ($i = 1; $i <= 20; $i++)
                        <div style="border-radius: 16px; overflow: hidden; aspect-ratio: 4/3;">
                            <img src="{{ asset('images/portfolio/3d/3D_PROD_' . $i . '.webp') }}"
                                 alt="3D Product {{ $i }}"
                ...
                {{-- 3D Visualizations Gallery --}}
                <div class="projects-header" style="margin-top: 100px;">
                    <h3 style="font-size: 32px; margin: 0;">{{ __('common.portfolio_3d_architectural') }}</h3>
                </div>

                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 24px; margin-top: 40px;">
                    @for ($i = 1; $i <= 35; $i++)
                        <div style="border-radius: 16px; overflow: hidden; aspect-ratio: 4/3;">
                            <img src="{{ asset('images/portfolio/3d/3D_VIZ_' . $i . '.webp') }}"
                                 alt="3D Visualization {{ $i }}"
                                 style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.3s ease;"
                                 onmouseover="this.style.transform='scale(1.05)'"
                                 onmouseout="this.style.transform='scale(1)'">
                        </div>
